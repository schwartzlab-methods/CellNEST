...
```
cellnest relay_celltype --input_dir='output/V1_Human_Lymph_Node_spatial/' --output_dir='output/V1_Human_Lymph_Node_spatial/' --annotation_file='relay_validation_sample_data/lymph_node/fractional_abundances_by_spot.csv' --modality='spot'
